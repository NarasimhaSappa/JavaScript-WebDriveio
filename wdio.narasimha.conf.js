const allureCL = require('allure-commandline')
const fs = require('fs')
exports.config = {
    //
    // ====================
    ...
    //     browserName: 'chrome',
    //     'goog:chromeOptions': {
    //         binary: '/path/to/chrome/binary', // Specify the correct path
    //     },
    // }],
    ...
    beforeTest: function (test, context) {
        ...
        allure.addTestId("Test Case: " + test.title); I
